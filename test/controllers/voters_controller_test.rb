...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { election_id: @voter.election_id, user_id: @voter.user_id } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { election_id: @voter.election_id, user_id: @voter.user_id } }
