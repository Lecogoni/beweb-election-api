...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { description: @election.description, started: @election.started, title: @election.title } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { description: @election.description, started: @election.started, title: @election.title } }
